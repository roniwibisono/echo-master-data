...
S('exp.global_multiplier',      'multiplier', 3.0, 3.0, 'double', 0.1, 100, 'Global EXP multiplier on ALL exp gains. Production 3.0: the faction quest line carries a player to ~L100 with a light optional grind (analysis-tuned).')
...
S('exp.multi_enemy_bonus',      'multiplier', 1.3, 1.3, 'double', 1.0, 50, 'EXP bonus vs multiple enemies.')
S('exp.elite_bonus',            'multiplier', 1.6, 1.6, 'double', 1.0, 50, 'EXP bonus vs elite/boss.')
S('exp.idle_multiplier',        'multiplier', 1.0, 1.0, 'double', 0.1, 500,'Idle/AFK EXP-per-minute multiplier.')
S('credit.idle_multiplier',     'multiplier', 1.0, 1.0, 'double', 0.1, 200, 'Idle credit-per-minute multiplier.')
S('quest.exp_multiplier',       'multiplier', 1.0, 1.0, 'double', 0.1, 100, 'Quest EXP reward multiplier (stacks with exp.global).')
